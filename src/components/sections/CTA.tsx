  ...
  return (
    <section id="contact" className="yen-section relative overflow-hidden" ref={ref}>
      ...
      <motion.div
        ...
        style={{
          background: "radial-gradient(circle, hsl(var(--yen-pink) / 0.1) 0%, transparent 70%)",
        }}
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.3, 0.5, 0.3],
      ...
      <motion.div
        ...
        style={{
          background: "radial-gradient(circle, hsl(var(--yen-pink) / 0.08) 0%, transparent 70%)",
        }}
        animate={{
          scale: [1.2, 1, 1.2],
          opacity: [0.2, 0.4, 0.2],
      ...
      <div className="yen-container relative z-10">
        ...
        >
          ...
          >
            <YENLogo variant="wordmark" size={180} className="max-w-[220px] sm:max-w-xs w-full" />
          </motion.div>
