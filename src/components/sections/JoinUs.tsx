        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          >
            <div className="mb-8">
              <svg viewBox="0 0 80 80" fill="none" className="w-20 h-20 mx-auto">
                ...
                <circle cx="40" cy="24" r="12" stroke="hsl(var(--yen-pink))" strokeWidth="2" />
                <path d="M20 72V60C20 52 28 44 40 44C52 44 60 52 60 60V72" stroke="hsl(var(--yen-pink))" strokeWidth="2" strokeLinecap="round" />
                {/* Crown/star element */}
                <path d="M30 8L32 14L40 12L48 14L50 8" stroke="hsl(var(--yen-pink))" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          ...
          >
            <div className="mb-8">
              <svg viewBox="0 0 80 80" fill="none" className="w-20 h-20 mx-auto">
                {/* Group of people */}
                <circle cx="28" cy="28" r="10" stroke="hsl(var(--yen-pink))" strokeWidth="2" />
                <circle cx="52" cy="28" r="10" stroke="hsl(var(--yen-pink))" strokeWidth="2" />
                <circle cx="40" cy="48" r="10" stroke="hsl(var(--yen-pink))" strokeWidth="2" />
                {/* Connection lines */}
                <path d="M28 38V50M52 38V50M32 52H48" stroke="hsl(var(--yen-pink))" strokeWidth="1" strokeOpacity="0.5" />
                {/* Rising arrow */}
                <path d="M60 72L60 58M60 58L52 66M60 58L68 66" stroke="hsl(var(--yen-pink))" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
