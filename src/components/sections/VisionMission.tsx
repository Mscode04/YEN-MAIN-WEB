  ...
  const cards = [
    {
      ...
      icon: (
        <svg viewBox="0 0 48 48" fill="none" className="w-12 h-12">
          <circle cx="24" cy="24" r="20" stroke="hsl(var(--yen-pink))" strokeWidth="1.5" />
          <path
            d="M24 12V24L32 28"
            stroke="hsl(var(--yen-pink))"
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
          <circle cx="24" cy="24" r="3" fill="hsl(var(--yen-pink))" />
        </svg>
      ),
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 48 48" fill="none" className="w-12 h-12">
          ...
          <path
            ...
            strokeLinecap="round"
          />
          <circle cx="24" cy="12" r="3" fill="hsl(var(--yen-pink))" />
          <circle cx="12" cy="36" r="3" fill="hsl(var(--yen-pink))" />
          <circle cx="36" cy="36" r="3" fill="hsl(var(--yen-pink))" />
        </svg>
      ),
    },
  ];
